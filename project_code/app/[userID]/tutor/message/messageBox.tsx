...
import {GET_TUTOR_NOTIFICATION} from "@/graphql/queries";
...
const MessageBox = () => {
    ...
    const {data, loading, error} = useQuery(GET_TUTOR_NOTIFICATION, {
        variables: {
            tutorId: params?.userID
        }
    });

    // Transforming the GraphQL data into the required format if it exists
